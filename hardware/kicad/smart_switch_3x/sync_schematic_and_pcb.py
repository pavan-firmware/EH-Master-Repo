...
# Complete footprint mapping for all components
FOOTPRINTS = {
    ...
    "F1": "Fuse:Fuseholder_TR5_Littelfuse_No560_No460",
    "MOV1": "Varistor:RV_Disc_D12mm_W4.2mm_P7.5mm",
    "NTC1": "Resistor_THT:R_Radial_Power_L11.0mm_W7.0mm_P5.00mm",
    "CX1": "Capacitor_THT:C_Rect_L13.0mm_W4.0mm_P10.00mm_FKS3_FKP3",
    "U2": "Converter_ACDC:Converter_ACDC_Hi-Link_HLK-PMxx",
    "C1": "Capacitor_THT:CP_Radial_D6.3mm_P2.50mm",
    "U3": "Package_TO_SOT_SMD:SOT-23-5",
    "C2": "Capacitor_SMD:CP_Elec_6.3x5.8",
    "U1": "RF_Module:ESP32-C3-WROOM-02",
    "R_EN": "Resistor_SMD:R_0603_1608Metric",
    "C_EN": "Capacitor_SMD:C_0603_1608Metric",
    "R_LED": "Resistor_SMD:R_0603_1608Metric",
    "LED1": "LED_SMD:LED_0603_1608Metric",
    "Q1": "Package_TO_SOT_SMD:SOT-23",
    "RG1": "Resistor_SMD:R_0603_1608Metric",
    "RPD1": "Resistor_SMD:R_0603_1608Metric",
    "K1": "Relay_THT:Relay_SPDT_SANYOU_SRD_Series_Form_C",
    "D1": "Diode_SMD:D_SOD-123",
    "RS1": "Resistor_SMD:R_2512_6332Metric",
    "CS1": "Capacitor_THT:C_Rect_L13.0mm_W4.0mm_P10.00mm_FKS3_FKP3",
    "Q2": "Package_TO_SOT_SMD:SOT-23",
    "RG2": "Resistor_SMD:R_0603_1608Metric",
    "RPD2": "Resistor_SMD:R_0603_1608Metric",
    "K2": "Relay_THT:Relay_SPDT_SANYOU_SRD_Series_Form_C",
    "D2": "Diode_SMD:D_SOD-123",
    "RS2": "Resistor_SMD:R_2512_6332Metric",
    "CS2": "Capacitor_THT:C_Rect_L13.0mm_W4.0mm_P10.00mm_FKS3_FKP3",
    "Q3": "Package_TO_SOT_SMD:SOT-23",
    "RG3": "Resistor_SMD:R_0603_1608Metric",
    "RPD3": "Resistor_SMD:R_0603_1608Metric",
    "K3": "Relay_THT:Relay_SPDT_SANYOU_SRD_Series_Form_C",
    "D3": "Diode_SMD:D_SOD-123",
    "RS3": "Resistor_SMD:R_2512_6332Metric",
    "CS3": "Capacitor_THT:C_Rect_L13.0mm_W4.0mm_P10.00mm_FKS3_FKP3",
    "U4": "Package_SO:SOIC-14_3.9x8.7mm_P1.27mm",
    "R_SHUNT": "Resistor_SMD:R_2512_6332Metric",
    "RHV1": "Resistor_SMD:R_1206_3216Metric",
    "J_SW1": "TerminalBlock_Phoenix:TerminalBlock_Phoenix_MKDS-1,5-2_1x02_P5.00mm_Horizontal",
    "RSW1": "Resistor_SMD:R_0603_1608Metric",
    "RPU1": "Resistor_SMD:R_0603_1608Metric",
    "CSW1": "Capacitor_SMD:C_0603_1608Metric",
    "TVS1": "Diode_SMD:D_SOD-523",
    "J_SW2": "TerminalBlock_Phoenix:TerminalBlock_Phoenix_MKDS-1,5-2_1x02_P5.00mm_Horizontal",
    "RSW2": "Resistor_SMD:R_0603_1608Metric",
    "RPU2": "Resistor_SMD:R_0603_1608Metric",
    "CSW2": "Capacitor_SMD:C_0603_1608Metric",
    "TVS2": "Diode_SMD:D_SOD-523",
    "J_SW3": "TerminalBlock_Phoenix:TerminalBlock_Phoenix_MKDS-1,5-2_1x02_P5.00mm_Horizontal",
    "RSW3": "Resistor_SMD:R_0603_1608Metric",
    "RPU3": "Resistor_SMD:R_0603_1608Metric",
    "CSW3": "Capacitor_SMD:C_0603_1608Metric",
    "TVS3": "Diode_SMD:D_SOD-523"
}

def update_schematic():
    sch_file = r"c:\Users\pavan\Downloads\Flutter\SMART_HOME_V1\hardware\kicad\smart_switch_3x\smart_switch_3x.kicad_sch"
    with open(sch_file, "r", encoding="utf-8") as f:
        content = f.read()

    # Inject footprints into schematic symbols
    ...
    for line in lines:
        if '(property "Reference"' in line:
            ...
            if len(parts) >= 4:
                cur_ref = parts[3]
        elif '(property "Footprint"' in line and cur_ref:
            if cur_ref in FOOTPRINTS:
                fp = FOOTPRINTS[cur_ref]
                # preserve effects
                if '(effects' in line:
                    effects_part = line[line.find('(effects'):]
                    line = f'\t\t(property "Footprint" "{fp}" {effects_part}'
                else:
                    line = f'\t\t(property "Footprint" "{fp}")'
            cur_ref = None
        out_lines.append(line)

    with open(sch_file, "w", encoding="utf-8") as f:
        f.write("\n".join(out_lines))
    print("Updated schematic with 100% matched footprints!")
...
def generate_pcb():
    ...
    # ==================== SECTION 1: MAINS AC POWER & PROTECTION (X: 100 - 127) ====================
    ...
    # CX1 Class-X2 Safety Cap (0.1uF 275V Box 10mm) at (108, 122)
    pcb.append(f'  (footprint "Capacitor_THT:C_Rect_L13.0mm_W4.0mm_P10.00mm_FKS3_FKP3" (layer "F.Cu") (at 108 122) (uuid "{uid()}")')
    ...
    # Body occupies X: 105 to 127, Y: 114 to 151. Perfectly fits inside AC Section without overlapping!
    ...
    pcb.append('  (segment (start 119 147.08) (end 133 146) (width 0.8) (layer "F.Cu") (net 3) (uuid "'+uid()+'"))')
    ...
    with open(target, "w", encoding="utf-8") as f:
        f.write('\n'.join(pcb))
    print(f"Generated synchronized PCB at {target}")
