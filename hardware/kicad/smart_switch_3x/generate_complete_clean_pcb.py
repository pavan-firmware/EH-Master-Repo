...
def main():
    ...
    # Relay SPST
    sch.append('\t\t(symbol "Relay:Relay_SPST"')
    ...
    def add_sym(lib_id, x, y, ref, val, angle=0):
        sch.append('\t(symbol')
    ...
    sch.append('\t(text "4. RELAYS (3X 10A 250VAC with RC Snubbers)" (at 160.0 100.0 0) (effects (font (size 2.54 2.54) (bold yes)) (justify left bottom)) (uuid "44444444-4444-4444-4444-444444444444"))')
    ...
    add_sym("Connector:Conn_01x03", 35.0, 55.0, "J1", "MAINS_IN")
    add_label("MAINS_LIVE", 40.08, 52.46)
    add_label("MAINS_NEUTRAL", 40.08, 55.0)
    add_label("EARTH_GND", 40.08, 57.54)

    add_sym("Device:Fuse", 60.0, 52.46, "F1", "2A_250V", 0)
    add_wire(40.08, 52.46, 56.19, 52.46)
    add_sym("Device:Varistor", 80.0, 55.0, "MOV1", "14D561K", 0)
    ...
    add_sym("Device:R", 100.0, 52.46, "NTC1", "10D-9", 90)
    add_wire(80.0, 52.46, 96.19, 52.46)
    add_sym("Device:C", 115.0, 55.0, "CX1", "0.1uF_275V_X2", 0)
    ...
    add_sym("Power_Supply:HLK-PM01", 185.0, 55.0, "U2", "HLK-PM01_5V")
    ...
    add_sym("Device:C_Polarized", 215.0, 55.0, "C1", "470uF_16V", 0)
    ...
    add_sym("Regulator_Linear:AP2112K-3.3", 240.0, 55.0, "U3", "AP2112K-3.3")
    ...
    add_sym("Device:C_Polarized", 260.0, 55.0, "C2", "100uF_10V", 0)
    ...
    add_sym("Device:R", 100.0, 150.24, "R_LED", "1k", 90)
    add_label("STATUS_LED", 93.0, 150.24, 180)
    add_wire(93.0, 150.24, 96.19, 150.24)
    add_sym("Device:LED", 112.0, 150.24, "LED1", "BLUE_0603", 0)
    ...
    for i, y_pos in enumerate(y_relays):
        ch = i + 1
        add_sym("Device:Q_NMOS_GSD", 185.0, y_pos, f"Q{ch}", "AO3400A")
        add_label(f"RELAY_DRV_{ch}", 170.0, y_pos, 180)
        add_sym("Device:R", 175.0, y_pos, f"RG{ch}", "1k", 90)
        add_wire(170.0, y_pos, 171.19, y_pos)
        add_wire(178.81, y_pos, 179.92, y_pos)
        add_sym("Device:R", 179.92, y_pos+6.0, f"RPD{ch}", "10k", 0)
        ...
        # Relay & Flyback Diode
        add_sym("Relay:Relay_SPST", 215.0, y_pos, f"K{ch}", "HF32F-G_10A")
        ...
        add_sym("Device:D_Schottky", 200.0, y_pos, f"D{ch}", "SS14", 90)
        add_wire(207.38, y_pos-2.54, 200.0, y_pos-3.81)
        add_wire(207.38, y_pos+2.54, 200.0, y_pos+3.81)

        # Snubber
        add_sym("Device:R", 235.0, y_pos-2.54, f"RS{ch}", "100_1W", 90)
        add_sym("Device:C", 248.0, y_pos-2.54, f"CS{ch}", "100nF_630V", 90)
    ...
    add_sym("Sensor_Energy:BL0942", 65.0, 215.0, "U4", "BL0942_SOP14")
    ...
    add_sym("Device:R", 30.0, 212.46, "R_SHUNT", "1mOhm_2W_1%", 0)
    ...
    add_sym("Device:R", 38.0, 222.62, "RHV1", "960k_HV", 90)
    ...
    # 2. GENERATE COMPLETE PRE-ROUTED PCB WITH ALL 53 COMPONENTS ON-BOARD
    pcb = []
    ...
    nets = [
        (0, '""'), (1, '"GND"'), (2, '"+3V3"'), (3, '"+5V"'),
        (4, '"MAINS_LIVE"'), (5, '"MAINS_NEUTRAL"'), (6, '"AC_L_FILTERED"'), (7, '"AC_N_FILTERED"'),
        (8, '"SW_IN_1"'), (9, '"SW_IN_2"'), (10, '"SW_IN_3"'),
        (11, '"RELAY_DRV_1"'), (12, '"RELAY_DRV_2"'), (13, '"RELAY_DRV_3"'),
        (14, '"LOAD_CH1"'), (15, '"LOAD_CH2"'), (16, '"LOAD_CH3"'),
        (17, '"BL0942_TX"'), (18, '"STATUS_LED"'), (19, '"BOOT_BTN"'), (20, '"NEUTRAL_LOAD"')
    ]
    ...
    # ALL 53 COMPONENTS PLACED INSIDE THE BOARD
    ...
    pcb.append('    (pad "1" thru_hole rect (at 0 -5.08) (size 2.5 2.5) (drill 1.3) (layers "*.Cu" "*.Mask") (net 4 "MAINS_LIVE"))')
    pcb.append('    (pad "2" thru_hole circle (at 0 0) (size 2.5 2.5) (drill 1.3) (layers "*.Cu" "*.Mask") (net 5 "MAINS_NEUTRAL"))')
    pcb.append('    (pad "3" thru_hole circle (at 0 5.08) (size 2.5 2.5) (drill 1.3) (layers "*.Cu" "*.Mask") (net 1 "GND"))')
    pcb.append('  )')
    ...
    pcb.append('    (pad "1" thru_hole rect (at -2.54 0) (size 2.2 2.2) (drill 1.1) (layers "*.Cu" "*.Mask") (net 4 "MAINS_LIVE"))')
    pcb.append('    (pad "2" thru_hole circle (at 2.54 0) (size 2.2 2.2) (drill 1.1) (layers "*.Cu" "*.Mask") (net 6 "AC_L_FILTERED"))')
    pcb.append('  )')
    ...
    pcb.append('    (pad "1" thru_hole rect (at -3.75 0) (size 2.2 2.2) (drill 1.1) (layers "*.Cu" "*.Mask") (net 6 "AC_L_FILTERED"))')
    pcb.append('    (pad "2" thru_hole circle (at 3.75 0) (size 2.2 2.2) (drill 1.1) (layers "*.Cu" "*.Mask") (net 5 "MAINS_NEUTRAL"))')
    pcb.append('  )')
    ...
    pcb.append('    (pad "1" thru_hole rect (at -2.5 0) (size 2.2 2.2) (drill 1.1) (layers "*.Cu" "*.Mask") (net 6 "AC_L_FILTERED"))')
    pcb.append('    (pad "2" thru_hole circle (at 2.5 0) (size 2.2 2.2) (drill 1.1) (layers "*.Cu" "*.Mask") (net 6 "AC_L_FILTERED"))')
    pcb.append('  )')
    ...
    pcb.append('    (pad "1" thru_hole rect (at -5.0 0) (size 2.2 2.2) (drill 1.1) (layers "*.Cu" "*.Mask") (net 6 "AC_L_FILTERED"))')
    pcb.append('    (pad "2" thru_hole circle (at 5.0 0) (size 2.2 2.2) (drill 1.1) (layers "*.Cu" "*.Mask") (net 5 "MAINS_NEUTRAL"))')
    pcb.append('  )')
    ...
    pcb.append('    (pad "1" thru_hole rect (at -14.7 -2.5) (size 2.5 2.5) (drill 1.2) (layers "*.Cu" "*.Mask") (net 6 "AC_L_FILTERED"))')
    pcb.append('    (pad "2" thru_hole circle (at -14.7 2.5) (size 2.5 2.5) (drill 1.2) (layers "*.Cu" "*.Mask") (net 5 "MAINS_NEUTRAL"))')
    pcb.append('    (pad "3" thru_hole circle (at 14.7 7.7) (size 2.5 2.5) (drill 1.2) (layers "*.Cu" "*.Mask") (net 3 "+5V"))')
    pcb.append('    (pad "4" thru_hole circle (at 14.7 -7.7) (size 2.5 2.5) (drill 1.2) (layers "*.Cu" "*.Mask") (net 1 "GND"))')
    pcb.append('  )')
    ...
    pcb.append('    (pad "1" thru_hole rect (at -1.25 0) (size 1.8 1.8) (drill 0.9) (layers "*.Cu" "*.Mask") (net 3 "+5V"))')
    pcb.append('    (pad "2" thru_hole circle (at 1.25 0) (size 1.8 1.8) (drill 0.9) (layers "*.Cu" "*.Mask") (net 1 "GND"))')
    pcb.append('  )')
    ...
    pcb.append('    (pad "1" smd rect (at -0.95 -1.35) (size 0.6 1.05) (layers "F.Cu" "F.Paste" "F.Mask") (net 3 "+5V"))')
    pcb.append('    (pad "2" smd rect (at 0 -1.35) (size 0.6 1.05) (layers "F.Cu" "F.Paste" "F.Mask") (net 1 "GND"))')
    pcb.append('    (pad "3" smd rect (at 0.95 -1.35) (size 0.6 1.05) (layers "F.Cu" "F.Paste" "F.Mask") (net 3 "+5V"))')
    pcb.append('    (pad "5" smd rect (at -0.95 1.35) (size 0.6 1.05) (layers "F.Cu" "F.Paste" "F.Mask") (net 2 "+3V3"))')
    pcb.append('  )')
    ...
    pcb.append('    (pad "1" smd rect (at -2.5 0) (size 2.0 1.2) (layers "F.Cu" "F.Paste" "F.Mask") (net 2 "+3V3"))')
    pcb.append('    (pad "2" smd rect (at 2.5 0) (size 2.0 1.2) (layers "F.Cu" "F.Paste" "F.Mask") (net 1 "GND"))')
    pcb.append('  )')
    ...
    pcb.append('    (pad "1" smd rect (at 6.5 -8.0 90) (size 1.5 0.9) (layers "F.Cu" "F.Paste" "F.Mask") (net 2 "+3V3"))')
    pcb.append('    (pad "2" smd rect (at 5.0 -8.0 90) (size 1.5 0.9) (layers "F.Cu" "F.Paste" "F.Mask") (net 2 "+3V3"))')
    pcb.append('    (pad "3" smd rect (at 3.5 -8.0 90) (size 1.5 0.9) (layers "F.Cu" "F.Paste" "F.Mask") (net 1 "GND"))')
    pcb.append('    (pad "4" smd rect (at 2.0 -8.0 90) (size 1.5 0.9) (layers "F.Cu" "F.Paste" "F.Mask") (net 8 "SW_IN_1"))')
    pcb.append('    (pad "5" smd rect (at 0.5 -8.0 90) (size 1.5 0.9) (layers "F.Cu" "F.Paste" "F.Mask") (net 9 "SW_IN_2"))')
    pcb.append('    (pad "6" smd rect (at -1.0 -8.0 90) (size 1.5 0.9) (layers "F.Cu" "F.Paste" "F.Mask") (net 10 "SW_IN_3"))')
    pcb.append('    (pad "7" smd rect (at -2.5 -8.0 90) (size 1.5 0.9) (layers "F.Cu" "F.Paste" "F.Mask") (net 17 "BL0942_TX"))')
    pcb.append('    (pad "8" smd rect (at -4.0 -8.0 90) (size 1.5 0.9) (layers "F.Cu" "F.Paste" "F.Mask") (net 18 "STATUS_LED"))')
    pcb.append('    (pad "9" smd rect (at -5.5 -8.0 90) (size 1.5 0.9) (layers "F.Cu" "F.Paste" "F.Mask") (net 19 "BOOT_BTN"))')
    pcb.append('    (pad "18" smd rect (at -2.5 8.0 90) (size 1.5 0.9) (layers "F.Cu" "F.Paste" "F.Mask") (net 11 "RELAY_DRV_1"))')
    pcb.append('    (pad "19" smd rect (at -1.0 8.0 90) (size 1.5 0.9) (layers "F.Cu" "F.Paste" "F.Mask") (net 12 "RELAY_DRV_2"))')
    pcb.append('    (pad "20" smd rect (at 0.5 8.0 90) (size 1.5 0.9) (layers "F.Cu" "F.Paste" "F.Mask") (net 13 "RELAY_DRV_3"))')
    pcb.append('  )')
    ...
    def add_smd_0603(ref, val, x, y, net1, net2):
        ...
        pcb.append(f'    (pad "1" smd rect (at -0.8 0) (size 0.8 0.9) (layers "F.Cu" "F.Paste" "F.Mask") (net {net1}))')
        pcb.append(f'    (pad "2" smd rect (at 0.8 0) (size 0.8 0.9) (layers "F.Cu" "F.Paste" "F.Mask") (net {net2}))')
        pcb.append('  )')
    ...
    pcb.append('    (pad "1" smd rect (at -0.8 0) (size 0.8 0.9) (layers "F.Cu" "F.Paste" "F.Mask") (net 18 "STATUS_LED"))')
    pcb.append('    (pad "2" smd rect (at 0.8 0) (size 0.8 0.9) (layers "F.Cu" "F.Paste" "F.Mask") (net 1 "GND"))')
    pcb.append('  )')
    ...
    pcb.append('    (pad "1" smd rect (at -2.7 -3.81) (size 1.5 0.6) (layers "F.Cu" "F.Paste" "F.Mask") (net 2 "+3V3"))')
    pcb.append('    (pad "2" smd rect (at -2.7 -2.54) (size 1.5 0.6) (layers "F.Cu" "F.Paste" "F.Mask") (net 5 "MAINS_NEUTRAL"))')
    pcb.append('    (pad "3" smd rect (at -2.7 -1.27) (size 1.5 0.6) (layers "F.Cu" "F.Paste" "F.Mask") (net 20 "NEUTRAL_LOAD"))')
    pcb.append('    (pad "4" smd rect (at -2.7 0) (size 1.5 0.6) (layers "F.Cu" "F.Paste" "F.Mask") (net 4 "MAINS_LIVE"))')
    pcb.append('    (pad "5" smd rect (at -2.7 1.27) (size 1.5 0.6) (layers "F.Cu" "F.Paste" "F.Mask") (net 1 "GND"))')
    pcb.append('    (pad "11" smd rect (at 2.7 -1.27) (size 1.5 0.6) (layers "F.Cu" "F.Paste" "F.Mask") (net 17 "BL0942_TX"))')
    pcb.append('  )')
    ...
    pcb.append('    (pad "1" smd rect (at -2.8 0) (size 1.6 3.2) (layers "F.Cu" "F.Paste" "F.Mask") (net 5 "MAINS_NEUTRAL"))')
    pcb.append('    (pad "2" smd rect (at 2.8 0) (size 1.6 3.2) (layers "F.Cu" "F.Paste" "F.Mask") (net 20 "NEUTRAL_LOAD"))')
    pcb.append('  )')
    ...
    pcb.append('    (pad "1" smd rect (at -1.5 0) (size 1.1 1.8) (layers "F.Cu" "F.Paste" "F.Mask") (net 4 "MAINS_LIVE"))')
    pcb.append('    (pad "2" smd rect (at 1.5 0) (size 1.1 1.8) (layers "F.Cu" "F.Paste" "F.Mask") (net 1 "GND"))')
    pcb.append('  )')
    ...
    for idx, yr in enumerate(y_relays):
        ...
        pcb.append(f'    (pad "1" smd rect (at -0.95 -1) (size 0.6 0.9) (layers "F.Cu" "F.Paste" "F.Mask") (net {10+ch} "RELAY_DRV_{ch}"))')
        pcb.append(f'    (pad "2" smd rect (at 0.95 -1) (size 0.6 0.9) (layers "F.Cu" "F.Paste" "F.Mask") (net 1 "GND"))')
        pcb.append(f'    (pad "3" smd rect (at 0 1) (size 0.6 0.9) (layers "F.Cu" "F.Paste" "F.Mask") (net {10+ch} "RELAY_DRV_{ch}"))')
        pcb.append('  )')
        ...
        pcb.append(f'    (pad "1" smd rect (at -1.4 0) (size 0.9 1.2) (layers "F.Cu" "F.Paste" "F.Mask") (net 3 "+5V"))')
        pcb.append(f'    (pad "2" smd rect (at 1.4 0) (size 0.9 1.2) (layers "F.Cu" "F.Paste" "F.Mask") (net {10+ch} "RELAY_DRV_{ch}"))')
        pcb.append('  )')

        # Relay HF32F-G
        pcb.append(f'  (footprint "Relay_THT:Relay_SPST_Hongfa_HF32F-G" (layer "F.Cu") (at 167 {yr}) (uuid "{uid()}")')
        pcb.append(f'    (fp_text reference "K{ch}" (at 0 -8) (layer "F.SilkS") (effects (font (size 1 1) (thickness 0.15))))')
        pcb.append(f'    (pad "1" thru_hole circle (at -6.0 -6.0) (size 2.2 2.2) (drill 1.2) (layers "*.Cu" "*.Mask") (net 3 "+5V"))')
        pcb.append(f'    (pad "2" thru_hole circle (at -6.0 6.0) (size 2.2 2.2) (drill 1.2) (layers "*.Cu" "*.Mask") (net {10+ch} "RELAY_DRV_{ch}"))')
        pcb.append(f'    (pad "3" thru_hole rect (at 6.0 -6.0) (size 2.5 2.5) (drill 1.3) (layers "*.Cu" "*.Mask") (net 4 "MAINS_LIVE"))')
        pcb.append(f'    (pad "4" thru_hole circle (at 6.0 6.0) (size 2.5 2.5) (drill 1.3) (layers "*.Cu" "*.Mask") (net {13+ch} "LOAD_CH{ch}"))')
        pcb.append('  )')
        ...
        pcb.append(f'    (pad "1" smd rect (at -2.8 0) (size 1.6 3.2) (layers "F.Cu" "F.Paste" "F.Mask") (net 4 "MAINS_LIVE"))')
        pcb.append(f'    (pad "2" smd rect (at 2.8 0) (size 1.6 3.2) (layers "F.Cu" "F.Paste" "F.Mask") (net {13+ch} "LOAD_CH{ch}"))')
        pcb.append('  )')
        ...
        pcb.append(f'    (pad "1" thru_hole rect (at -5.0 0) (size 2.0 2.0) (drill 1.0) (layers "*.Cu" "*.Mask") (net 4 "MAINS_LIVE"))')
        pcb.append(f'    (pad "2" thru_hole circle (at 5.0 0) (size 2.0 2.0) (drill 1.0) (layers "*.Cu" "*.Mask") (net {13+ch} "LOAD_CH{ch}"))')
        pcb.append('  )')
    ...
    pcb.append('    (pad "1" thru_hole rect (at -5.08 0 90) (size 2.5 2.5) (drill 1.3) (layers "*.Cu" "*.Mask") (net 14 "LOAD_CH1"))')
    pcb.append('    (pad "2" thru_hole circle (at 0 0 90) (size 2.5 2.5) (drill 1.3) (layers "*.Cu" "*.Mask") (net 15 "LOAD_CH2"))')
    pcb.append('    (pad "3" thru_hole circle (at 5.08 0 90) (size 2.5 2.5) (drill 1.3) (layers "*.Cu" "*.Mask") (net 16 "LOAD_CH3"))')
    pcb.append('  )')
    ...
    for idx, x_sw in enumerate([148, 158, 168]):
        ...
        pcb.append(f'    (pad "1" thru_hole rect (at -1.75 0) (size 2.0 2.0) (drill 1.1) (layers "*.Cu" "*.Mask") (net {7+ch} "SW_IN_{ch}"))')
        pcb.append(f'    (pad "2" thru_hole circle (at 1.75 0) (size 2.0 2.0) (drill 1.1) (layers "*.Cu" "*.Mask") (net 1 "GND"))')
        pcb.append('  )')
        ...
        pcb.append(f'    (pad "1" smd rect (at -0.7 0) (size 0.6 0.6) (layers "F.Cu" "F.Paste" "F.Mask") (net {7+ch} "SW_IN_{ch}"))')
        pcb.append(f'    (pad "2" smd rect (at 0.7 0) (size 0.6 0.6) (layers "F.Cu" "F.Paste" "F.Mask") (net 1 "GND"))')
        pcb.append('  )')
    ...
    print("Generated 100% complete clean KiCad schematic & fully placed/routed PCB!")
