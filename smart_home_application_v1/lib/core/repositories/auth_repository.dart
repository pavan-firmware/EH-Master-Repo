...
class UserProfile {
  ...
  UserProfile({required this.id, required this.email, required this.emailVerified});
...
class AuthRepository {
  ...
  Future<void> login(String email, String password) async {
    final data = await _apiClient.post('/api/v1/auth/login', body: {
      'email': email,
      'password': password,
    });
  ...
  Future<void> register(String email, String password) async {
    await _apiClient.post('/api/v1/auth/register', body: {
      'email': email,
      'password': password,
    });
  ...
  Future<void> _saveAuthData(Map<String, dynamic> data) async {
    ...
    await _storage.write(key: _userProfileKey, value: jsonEncode(_currentUser!.toJson()));
  }
}
