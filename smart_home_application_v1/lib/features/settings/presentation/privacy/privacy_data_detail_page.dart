...
import '../../../../core/models/privacy_models.dart';import '../settings_ui.dart';
  ...
  Widget build(BuildContext context) => NestedSettingsScaffold(
    ...
    child: ListView(
      ...
      children: [
        ...
        const Text('WHAT WE STORE', style: TextStyle(fontWeight: FontWeight.w800, color: SettingsColors.muted)),
        const SizedBox(height: 10),
        SettingsCheckList(items: category.details),
        const SizedBox(height: 20),
        const Text('WHY WE USE IT', style: TextStyle(fontWeight: FontWeight.w800, color: SettingsColors.muted)),
