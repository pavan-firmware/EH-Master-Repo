...
void main() {
  ...
  group('DeviceStorageService & HomeController Hydration Tests', () {
    ...
    test(
      'Saving and loading commissioned device preserves real hardware metadata',
      () async {
    ...
    test(
      'HomeController hydrates persisted device and transitions dashboard to live device',
      () async {
        const device = ConnectedDeviceSummary(
          id: '4444688e-989d-458e-820e-ac62a99ed8e1',
          name: 'EH Smart Switch 3X',
    ...
    test(
      'Room management: adding custom rooms preserves unique entries',
      () async {
