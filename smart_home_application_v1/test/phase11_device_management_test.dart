...
void main() {
  group('Phase 11 — Device Management Models & Repository Tests', () {
    ...
    test('CloudDeviceManagementRepository routes API calls correctly', () async {
      ...
      mockApi
          .mockResponses['GET /api/v1/homes/home_1/devices/dev_1/activity?limit=50'] = {
        'data': [
          {
            'id': 'act_1',
            'device_id': 'dev_1',
      ...
      expect(
        mockApi.recordedCalls,
        contains('GET /api/v1/homes/home_1/devices/dev_1/details'),
      );
      ...
      expect(
        mockApi.recordedCalls,
        contains('PATCH /api/v1/homes/home_1/devices/dev_1/rename'),
      );

      await repo.moveDevice('home_1', 'dev_1', 'room_2');
      expect(
        mockApi.recordedCalls,
        contains('PATCH /api/v1/homes/home_1/devices/dev_1/move'),
      );

      await repo.removeDevice('home_1', 'dev_1');
      expect(
        mockApi.recordedCalls,
        contains('DELETE /api/v1/homes/home_1/devices/dev_1'),
      );
    });
  });

  group('Phase 11 — DeviceManagementPage Widget Tests', () {
    testWidgets('DeviceManagementPage renders details, health, and activity', (
      tester,
    ) async {
